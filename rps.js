    ...
    function playRound(playerInput, computerSelection) {
      ...
      if ((playerInput == 'Rock') && (computerSelection == 'Paper')) {
        ...
        computer_pick.textContent = 'Your opponent chose Paper';
        ...
        computerScore ++;
            ...
            your_pick.textContent = 'You chose Rock';
            computer_pick.textContent = 'Your opponent chose Scissors';
            ...
            your_pick.textContent = 'You chose Paper';
            computer_pick.textContent = 'Your opponent chose Scissors';
            ...
            your_pick.textContent = 'You chose Paper';
            computer_pick.textContent = 'Your opponent chose Rock';
            ...
            your_pick.textContent = 'You chose Scissors';
            computer_pick.textContent = 'Your opponent chose Rock';
            ...
            your_pick.textContent = 'You chose ' + playerInput;
            computer_pick.textContent = 'Your opponent chose ' + computerSelection;
